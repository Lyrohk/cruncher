...
#'
#'@param id Character. UUID or permalink of the address you wish to look up
...
lookupAddress <- function(id, please_parse = TRUE, print_error = TRUE)  {
  return(lookupEntity(id = id, path = "addresses", please_parse = please_parse, print_error = print_error))
}