#' Function to lookup a single job over the Entity Lookup API Endpoint
#'
#'@param id UUID or permalink of the job you wish to look up
...
lookupJob <- function(id, please_parse = TRUE, print_error = TRUE)  {
  return(lookupEntity(id = id, path = "jobs", please_parse = please_parse, print_error = print_error))
}