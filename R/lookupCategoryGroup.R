...
lookupCategoryGroup <- function(id, please_parse = TRUE, print_error = TRUE)  {
  return(lookupEntity(id = id, path = "category_groups", please_parse = please_parse, print_error = print_error))
}