...
lookupFundingRounds <- function(funding_rounds, please_parse = TRUE, print_error = TRUE) {
  return(lookupEntities(entities = funding_rounds, path = "funding_rounds", please_parse = please_parse, print_error = print_error))
}