#' Function to lookup a single location over the Entity Lookup API Endpoint
#'
#'@param id UUID or permalink of the location you wish to look up
...
lookupLocation <- function(id, please_parse = TRUE, print_error = TRUE)  {
  return(lookupEntity(id = id, path = "locations", please_parse = please_parse, print_error = print_error))
}